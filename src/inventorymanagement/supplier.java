...
public class supplier extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Suppliers' Info:");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            ResultSet rs = s.executeQuery("SELECT COUNT(*) as count FROM supplier");
            if (rs.next() && rs.getInt("count") == 0) {
                // If table is empty, reset the auto-increment counter to 1
                s.executeUpdate("ALTER TABLE supplier AUTO_INCREMENT = 1");
            } else {
                // Get the current maximum ID
                rs = s.executeQuery("SELECT MAX(sid) as max_id FROM supplier");
                if (rs.next()) {
                    int maxId = rs.getInt("max_id");
                    // Reset auto-increment to the next available ID
                    s.executeUpdate("ALTER TABLE supplier AUTO_INCREMENT = " + (maxId + 1));
                }
            }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            ...
            if (rs.next()) {
                ...
                JOptionPane.showMessageDialog(this, "No supplier found with ID: " + search,
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            try {
                ...
                // Get the current maximum ID
                ResultSet rs = s.executeQuery("SELECT MAX(sid) as max_id FROM supplier");
                if (rs.next()) {
                    int maxId = rs.getInt("max_id");
                    // Reset auto-increment to the next available ID
                    s.executeUpdate("ALTER TABLE supplier AUTO_INCREMENT = " + (maxId + 1));
